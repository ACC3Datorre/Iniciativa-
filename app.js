...
function applyBrazo() {
  ...
  if (display) {
    ...
    if (state.brazo === 'A') display.textContent = 'BRAZO A — CUANTITATIVO';
    else if (state.brazo === 'B') display.textContent = 'BRAZO B — CUALITATIVO';
    else if (state.brazo === 'facilitador') display.textContent = 'FACILITADOR (ve todo)';
